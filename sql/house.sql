...
CREATE TABLE `installment`  (
  `i_contract_id` int NOT NULL COMMENT '合同id',
  ...
  PRIMARY KEY (`i_contract_id`) USING BTREE,
  CONSTRAINT `installment_ibfk_1` FOREIGN KEY (`i_contract_id`) REFERENCES `contract` (`c_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
